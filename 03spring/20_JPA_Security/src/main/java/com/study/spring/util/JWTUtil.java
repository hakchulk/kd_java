...
public class JWTUtil {
	private static String keyStr = "1234567890123456789012345678901234567890";

	public static String generateToken(Map<String, Object> valueMap, int min) {
		SecretKey key = null;

		try {
			key = Keys.hmacShaKeyFor(JWTUtil.keyStr.getBytes("UTF-8"));
		} catch (Exception e) {
	...
	public static Map<String, Object> validateToken(String token)
		...
		SecretKey key = Keys.hmacShaKeyFor(JWTUtil.keyStr.getBytes("UTF-8"));
